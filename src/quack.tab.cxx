...
#line 676 "quack.tab.cxx" // lalr1.cc:919
  ...
  case 16:
#line 182 "quack.yxx" // lalr1.cc:919
...
#line 694 "quack.tab.cxx" // lalr1.cc:919
  ...
  case 19:
#line 191 "quack.yxx" // lalr1.cc:919
    {(yylhs.value.ident) = (yystack_[0].value.ident);}
#line 700 "quack.tab.cxx" // lalr1.cc:919
    break;

  case 20:
#line 192 "quack.yxx" // lalr1.cc:919
    {(yylhs.value.ident) = new AST::Ident("None"); }
#line 706 "quack.tab.cxx" // lalr1.cc:919
    break;

  case 21:
#line 193 "quack.yxx" // lalr1.cc:919
    {(yylhs.value.ident) = new AST::Ident("None"); }
#line 712 "quack.tab.cxx" // lalr1.cc:919
    break;

  case 22:
#line 198 "quack.yxx" // lalr1.cc:919
...
#line 720 "quack.tab.cxx" // lalr1.cc:919
  ...
  case 23:
#line 201 "quack.yxx" // lalr1.cc:919
    { (yylhs.value.block) = new AST::Block(); }
#line 726 "quack.tab.cxx" // lalr1.cc:919
    break;

  case 24:
#line 207 "quack.yxx" // lalr1.cc:919
    {  (yylhs.value.block) = (yystack_[1].value.block); }
#line 732 "quack.tab.cxx" // lalr1.cc:919
    break;

  case 25:
#line 224 "quack.yxx" // lalr1.cc:919
    { (yylhs.value.statement) = new AST::While(*(yystack_[1].value.expr), *(yystack_[0].value.block)); }
#line 738 "quack.tab.cxx" // lalr1.cc:919
    break;
...
#line 744 "quack.tab.cxx" // lalr1.cc:919
    break;

  case 27:
#line 231 "quack.yxx" // lalr1.cc:919
    { (yylhs.value.block) = new AST::Block();
...
#line 752 "quack.tab.cxx" // lalr1.cc:919
  ...
  case 28:
#line 235 "quack.yxx" // lalr1.cc:919
    { (yylhs.value.block) = (yystack_[0].value.block); }
#line 758 "quack.tab.cxx" // lalr1.cc:919
    break;

  case 29:
#line 237 "quack.yxx" // lalr1.cc:919
    { (yylhs.value.block) = new AST::Block(); }
#line 764 "quack.tab.cxx" // lalr1.cc:919
    break;

  case 30:
#line 249 "quack.yxx" // lalr1.cc:919
    { (yylhs.value.statement) = new AST::Assign(*(yystack_[3].value.l_expr), *(yystack_[1].value.expr)); }
#line 770 "quack.tab.cxx" // lalr1.cc:919
    break;
...
#line 820 "quack.tab.cxx" // lalr1.cc:919
  ...
  case 39:
#line 277 "quack.yxx" // lalr1.cc:919
...
#line 856 "quack.tab.cxx" // lalr1.cc:919
  ...
  case 45:
#line 310 "quack.yxx" // lalr1.cc:919
...
#line 889 "quack.tab.cxx" // lalr1.cc:919
  ...
  case 50:
#line 328 "quack.yxx" // lalr1.cc:919
...
#line 949 "quack.tab.cxx" // lalr1.cc:919
  ...
  case 60:
#line 359 "quack.yxx" // lalr1.cc:919
...
#line 967 "quack.tab.cxx" // lalr1.cc:919
    break;

  case 63:
#line 367 "quack.yxx" // lalr1.cc:919
    { (yylhs.value.expr) = new AST::Construct(*(yystack_[3].value.ident), *(yystack_[1].value.actuals)); }
#line 973 "quack.tab.cxx" // lalr1.cc:919
    break;

  case 64:
#line 370 "quack.yxx" // lalr1.cc:919
    { (yylhs.value.ident) = new AST::Ident((yystack_[0].value.str)); }
#line 979 "quack.tab.cxx" // lalr1.cc:919
    break;


#line 983 "quack.tab.cxx" // lalr1.cc:919
            default:
              break;
            }
        }
...
#line 1459 "quack.tab.cxx" // lalr1.cc:1242
#line 372 "quack.yxx" // lalr1.cc:1243
