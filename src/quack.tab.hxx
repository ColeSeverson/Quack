...
#line 14 "quack.yxx" // lalr1.cc:401
...
#line 57 "quack.tab.hxx" // lalr1.cc:401
...
namespace yy {
#line 168 "quack.tab.hxx" // lalr1.cc:401
  ...
  public:
    ...
    union semantic_type
    {
    #line 42 "quack.yxx" // lalr1.cc:401
    ...
    // These can all use the append method
    AST::Actuals* actuals;
    AST::Block* block;
    AST::Classes* classes;
    AST::Formals* formals;
...
#line 207 "quack.tab.hxx" // lalr1.cc:401
    };
#else
...
#line 734 "quack.tab.hxx" // lalr1.cc:401
